...
7. License
   TUXMIO is proudly open in both mind and design.
All software and firmware are shared under the MIT License — free to use, modify, and remix however you like.
All hardware designs (schematics, PCBs, 3D models) follow the CERN Open Hardware License – Permissive v2.0, allowing you to build, improve, and even sell your own versions, as long as you keep the original attribution intact! 😊
